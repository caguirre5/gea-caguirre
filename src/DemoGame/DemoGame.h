...
class SquareSpawnSetupSystem : public SetupSystem {
  void run() {
    ...
    square->addComponent<TextureComponent>("/home/cristian/Documents/gea-2024-bhg/assets/Sprites/cat.png");
    square->addComponent<SpriteComponent>("/home/cristian/Documents/gea-2024-bhg/assets/Sprites/cat.png", 8, 8, 10, 8, 1000);
  }
};
